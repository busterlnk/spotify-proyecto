<template>
    <div>
        ...
        <div class="container-weektracks">
            <div  v-for="track in tracksOfTheWeek" :key="track.id" class="container-track">
                <div class="left-week">
                    <img v-bind:src="track.img" alt="" class="image-artist">
                    <div class="names">
                        <p class="title">{{track.artist}}</p>
                        <p class="subtitle">{{track.song}}</p>
                    </div>
                </div>
